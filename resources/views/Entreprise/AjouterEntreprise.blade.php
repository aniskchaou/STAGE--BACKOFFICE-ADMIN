	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				...
				<legend>  &nbsp;<i class="fa fa-plus-square fa-lg"></i>&nbsp;<i>Ajouter Entreprise</i></legend>
				<div class="panel-body">
					...
					@endif
	                 ...
	                 <form class="form-horizontal" role="form" method="POST" action="{{ url('/entreprise')}}">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_nom" value="{{old('ent_nom') }}">	    
							</div>
						</div>
					    <div class="form-group">
							<label class="col-md-4 control-label">Statut juridique</label>
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_statut_juridique" value="{{old('ent_statut_juridique') }}">	    
							</div>
						</div> 
						...
						<div class="form-group">
							...
							<div class="col-md-3">
							<input type="text" class="form-control" name="ent_nbr" value="{{old('ent_nbr')}}">	    
							</div>
						</div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-md-3">
							<select class="form-control chosen-select-no-single" data-placeholder="sélectionner" name="ent_pays" value="{{old('ent_pays')}}">
                         <option value="{{old('ent_pays')}}">{{old('ent_pays')}}</option>	
					    ...
					    <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_ville" value="{{old('ent_ville')}}">	    
							</div>
						</div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_adresse" value="{{old('ent_adresse') }}">	    
							</div>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="ent_fax" value="{{old('ent_fax')}}">	    
							</div></div>
						</div>
					    ...
					    <div class="form-group">
							...
							<input type="text" class="form-control" name="ent_tel" value="{{old('ent_tel')}}">	    
							</div></div>
						</div>
					     <div class="form-group">
							...
							<input type="text" class="form-control" name="ent_web" value="{{old('ent_web')}}">	    
							</div></div>
						</div>
