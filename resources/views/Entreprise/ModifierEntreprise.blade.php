...
<ol class="breadcrumb">
  ...
  <li class="active">Modifier Entreprise</li>
</ol>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				...
				<legend>  &nbsp;<i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;<i>Modifier Entreprise</i></legend>
					...
					@endif
	                 ...
	                 <form class="form-horizontal" role="form" method="POST" action="{{ url('entreprise/'.$Entreprise->id)}}">
                        ...
                        <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_nom" value="{{$Entreprise->ent_nom}}">	    
							</div>
						</div>
					    <div class="form-group">
							<label class="col-md-4 control-label">Statut juridique</label>
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_statut_juridique" value="{{$Entreprise->ent_statut_juridique}}">	    
							</div>
						</div> 
                         ...
                         <div class="form-group">
							...
							<div class="col-md-5">
						     <select class="form-control chosen-select" data-placeholder="sélectionner" name="secteur_id" >
                               <option value=""></option>

                                @foreach($Secteur as $sec)
                                @if($sec->id == $Entreprise->secteur_id)
                               <option value="{{$sec->id}}" selected="selected">{{$sec->secteur_nom}}</option>
                                @else
                                <option value="{{$sec->id}}">{{$sec->secteur_nom}}</option>
						...
						<div class="form-group">
							...
							<div class="col-md-3">
							<input type="text" class="form-control" name="ent_nbr" value="{{$Entreprise->ent_nbr}}">	    
							</div>
						</div>
	                    ...
	                    <div class="form-group">
							...
							<select class="form-control chosen-select-no-single" data-placeholder="sélectionner" name="ent_pays" >
                    <option value="{{$Entreprise->ent_pays}}">{{$Entreprise->ent_pays}}</option>
					    ...
					    <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_ville" value="{{$Entreprise->ent_ville}}">	    
							</div>
						</div>
	                    ...
	                    <div class="form-group">
							...
							<div class="col-md-6">
							<input type="text" class="form-control" name="ent_adresse" value="{{$Entreprise->ent_adresse}}">	    
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<div class="input-group">
                                 <span class="input-group-addon" id="basic-addon2"><span class="glyphicon glyphicon-phone-alt"></span></span>
							<input type="text" class="form-control" name="ent_fax" value="{{$Entreprise->ent_fax}}">	    
							</div></div>
						</div>
					    ...
					    <div class="form-group">
							...
							<input type="text" class="form-control" name="ent_tel" value="{{$Entreprise->ent_tel}}">	    
							</div></div>
						</div>
					     <div class="form-group">
							...
							<input type="text" class="form-control" name="ent_web" value="{{$Entreprise->ent_web}}">	    
							</div></div>
						</div>
                        ...
                        <div class="form-group">
							...
							<input type="text" class="form-control" name="email" value="{{$Entreprise->email}}">	    
							</div></div>
						</div>
