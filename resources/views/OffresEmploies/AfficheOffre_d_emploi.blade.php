...
@section('conten')
 ...
 <ol class="breadcrumb">
  ...
  <li class="active">Gérer Les Offres D'emplois</li>
</ol>
    ...
    <select class="form-control  chosen-select-deselect " data-placeholder="Rechercher par Secteur" id="engines2"  >
     ...
     <option value="{{$Sec->secteur_nom}}">{{$Sec->secteur_nom}}</option>
      @endforeach
        ...
        <td style="width:10px"></td>
    <td width="10%">    
   <select class="form-control  chosen-select-no" data-placeholder="Rechercher par État" id="etat"  >
     <option value=" "> </option>
...
<div class="panel panel-default">
  ...
  <legend>  &nbsp;<i class="fa fa-cog fa-spin fa-lg"></i>&nbsp;<i>Gérer Les Offres D'emplois</i></legend>
...
$(document).ready(function() {
 ...
 $('#engines').change( function() { table.column(3).search($(this).val()).draw(); } );
  $('#etat').change( function() { table.column(7).search($(this).val()).draw(); } );
