...
<ol class="breadcrumb">
  ...
  <li class="active">Imprimer liste des stages</li>
</ol>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				  ...
				  <legend>&nbsp;<i class="fa fa-print fa-lg"></i>&nbsp;<i>Imprimer liste des stages</i></legend>
				<div class="panel-body">
					...
					@endif
	                 ...
	                 <form class="form-horizontal" role="form" method="POST" action="{{ url('stage/imprimer')}}">
