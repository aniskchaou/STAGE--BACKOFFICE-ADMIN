...
<ol class="breadcrumb">
  ...
  <li class="active">Modifier Administrateur</li>
</ol>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<legend>  &nbsp; <i class="fa fa-pencil-square-o fa-1x"></i>&nbsp;<i>Modifier Administrateur</i></legend>
				<div class="panel-body">
					...
					@endif
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="Login" value="{{$User->name}}">		    
							</div>
						</div> 
						<div class="form-group">
